  ...
  <table>
    ...
    <tr>
      ...
      <td><input type="text" name="date"
                 value="<calendar:formatDate value="${flight.date}" pattern="yyyy-MM-dd"/>"/></td>
    </tr>
    <tr>
      <td>Time</td>
      <td><input type="text" name="time" value="<calendar:formatDate value="${flight.time}" pattern="HH:mm"/>"/>
      </td>
    </tr>
    <tr>
      <td>Duration</td>
      <td><input type="text" name="duration"
                 value="<calendar:formatDate value="${flight.duration}" pattern="HH:mm"/>"/></td>
    </tr>
    <tr>
      <td>Team number</td>
